...
console.log(comprobarSiEsPar(4)); 
console.log(comprobarSiEsPar(7)); 
...
//
const areaTriangulo = (b = 10, h = 5) => (b * h) / 2;

console.log(areaTriangulo());     // 25 
console.log(areaTriangulo(8, 4)); // 16
...
function datos (nombre, ...dpersonas) {
    for (const msg of dpersonas){
        console.log(`[${nombre}] ${msg}`);
    }
}
datos("deyvi", "feliz", "triste", "necio");
