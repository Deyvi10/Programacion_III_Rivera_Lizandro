...
console.log(personas.saludar());      // "Hola, soy Ana y tengo 28 años."
console.log(personas.cumpleaños());   // "¡Feliz cumpleaños, Ana! Ahora tienes 29."
console.log(personas.saludarArrow()); // "Hola, soy undefined"
