...
let montoCompra = prompt("Ingresa el monto de la compra ");
montoCompra = parseFloat(montoCompra);
if (montoCompra > 100 ){
    console.log("Aplica descuento");
}

let velocidad = prompt("Ingresa la Velocidad de un vehiculo ");
velocidad = parseFloat(velocidad);
if (velocidad > 90){
    console.log("Exeso de velocidad");
}

let asistencias = prompt("Ingresa las asistencias del estudiante ");
